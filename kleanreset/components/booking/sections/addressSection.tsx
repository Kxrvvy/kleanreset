...
// Province isn't asked for — the business serves Edmonton, AB, so it's
// defaulted to "AB" in the form's defaultValues and submitted automatically.
  ...
  return (
    <SectionCard step={3} id="section-address" title="Property address" subtitle="Where should we come?">
      <div className="space-y-4">
        <div>
          <TextInput label="Full address" placeholder="123 Main St" {...register("address.street")} />
